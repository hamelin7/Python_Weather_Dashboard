...
#we are sending 7 data points of weather data to our adafruit.io dashboard so we can send those 7 data points every 15 seconds without risking exceeding the rate limit
